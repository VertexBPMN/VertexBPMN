...
public class ValidationRuleRegistryTests
{
    ...
    public void AllCurrentRuleCodes_AreRegistered()
    {
        ...
        string[] expected =
        {
            ...
            "VEN-VERTEX-CONNECTOR-TYPE","VEN-VERTEX-CONNECTOR-OPERATION","VEN-VERTEX-WEBHOOK-PATH",
            "VEN-VERTEX-TRIGGER-TYPE","VEN-VERTEX-TRIGGER-PROCESS-KEY",
            "VEN-VERTEX-CREDENTIAL-ID","VEN-VERTEX-CREDENTIAL-KIND"
        };
