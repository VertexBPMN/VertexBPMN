...
| Debugging | Debug, Visual Debug, Visual Debugger | BPMN-Trace sowie Visual-Debug-Session, Breakpoint, Continue, Variableninspektion und persistentes Step-over über gespeicherte ExecutionTokens/HistoryEvents integriert; die Prozessvisualisierung bleibt deaktiviert, solange keine dedizierte Visualisierungsoperation existiert | P2 |
