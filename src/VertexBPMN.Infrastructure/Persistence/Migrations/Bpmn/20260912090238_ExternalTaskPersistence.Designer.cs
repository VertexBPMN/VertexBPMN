...
namespace VertexBPMN.Infrastructure.Persistence.Migrations.Bpmn
{
    ...
    [Migration("20260912090238_ExternalTaskPersistence")]
    partial class ExternalTaskPersistence
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VertexBPMN.Domain.Entities.ExternalTaskAttempt", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("WorkerIssuer")
                        .IsRequired()
                        .HasColumnType("TEXT");

                    b.Property<string>("WorkerSubject")
                        .IsRequired()
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("JobId", "LeaseGeneration")
                        .IsUnique();

                    b.ToTable("ExternalTaskAttempts");
                });

            modelBuilder.Entity("VertexBPMN.Domain.Entities.ExternalTaskContinuation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("ExternalTaskContinuations");
                });

            modelBuilder.Entity("VertexBPMN.Domain.Entities.ExternalTaskJob", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("AgentProfileRef")
                        .HasMaxLength(128)
                        .HasColumnType("TEXT");

                    b.Property<string>("AgentProfileVersion")
                        .HasMaxLength(128)
                        .HasColumnType("TEXT");

                    b.Property<int>("AttemptsStarted")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("WaitTokenId")
                        .IsUnique();

                    b.HasIndex("TenantId", "ActivityExecutionId")
                        .IsUnique();

                    b.HasIndex("State", "Deadline", "Id");

                    b.HasIndex("State", "LeaseExpiresAt", "Id");

                    b.HasIndex("TenantId", "Topic", "State", "AvailableAt", "Id");

                    b.ToTable("ExternalTaskJobs", null, t =>
                        {
                            t.HasCheckConstraint("CK_ExternalTaskJobs_Attempts", "\"MaxAttempts\" >= 1 AND \"MaxAttempts\" <= 10 AND \"AttemptsStarted\" >= 0 AND \"AttemptsStarted\" <= \"MaxAttempts\"");

                            t.HasCheckConstraint("CK_ExternalTaskJobs_Lease", "\"State\" <> 'Leased' OR (\"LeaseId\" IS NOT NULL AND \"LeaseExpiresAt\" IS NOT NULL AND \"WorkerIssuer\" IS NOT NULL AND \"WorkerSubject\" IS NOT NULL AND \"LeaseGeneration\" > 0 AND \"AttemptsStarted\" > 0 AND \"LeaseExpiresAt\" <= \"Deadline\")");

                            t.HasCheckConstraint("CK_ExternalTaskJobs_Revision", "\"Revision\" >= 0 AND \"LeaseGeneration\" >= 0");

                            t.HasCheckConstraint("CK_ExternalTaskJobs_State", "\"State\" IN ('Ready','Leased','RetryScheduled','Completed','Failed','Cancelled','TimedOut')");

                            t.HasCheckConstraint("CK_ExternalTaskJobs_Time", "\"Deadline\" > \"CreatedAt\" AND \"AvailableAt\" >= \"CreatedAt\"");
                        });
                });
            ...
            modelBuilder.Entity("VertexBPMN.Domain.Entities.ExternalTaskAttempt", b =>
                {
                    b.HasOne("VertexBPMN.Domain.Entities.ExternalTaskJob", null)
                        .WithMany()
                        .HasForeignKey("JobId")
            ...
            modelBuilder.Entity("VertexBPMN.Domain.Entities.ExternalTaskJob", b =>
                {
                    b.HasOne("VertexBPMN.Domain.Entities.ProcessDefinition", null)
                        .WithMany()
