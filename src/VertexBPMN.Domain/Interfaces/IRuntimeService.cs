...
public interface IRuntimeService
{
    ...
    ValueTask<MessageCorrelationResult> CorrelateMessageAsync(string messageName, string? processInstanceId, IDictionary<string, object>? variables = null, CancellationToken cancellationToken = default, string? tenantId = null, string? idempotencyKey = null);

    // Vertex-kompatible Signal-API
    ValueTask BroadcastSignalAsync(string signalName, IDictionary<string, object>? variables = null, CancellationToken cancellationToken = default, string? tenantId = null, string? idempotencyKey = null);

    // Vorhandene Methoden
    ValueTask<ProcessInstance> StartProcessByKeyAsync(string processDefinitionKey, IDictionary<string, object>? variables = null, string? businessKey = null, string? tenantId = null, CancellationToken cancellationToken = default, string? idempotencyKey = null);
