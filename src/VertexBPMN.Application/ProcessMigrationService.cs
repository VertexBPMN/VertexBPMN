...
namespace VertexBPMN.Application
{
    public class ProcessMigrationService : IProcessMigrationService
    {
        ...
        public ProcessMigrationResult MigrateInstances(ProcessMigrationPlan plan)
        {
            ...
            var sourceInstances = new List<ProcessInstance>();
        ...
        private List<ProcessInstance> GetProcessInstancesByDefinition(string processDefinitionId)
        {
        ...
        private ProcessInstance MigrateInstance(ProcessInstance instance, ProcessMigrationPlan plan)
        {
        ...
        private List<HistoryEvent> GetHistoryEventsByInstance(string processInstanceId)
        {
            // TODO: Replace with repository/service call
        ...
        private void MigrateHistoryEvent(HistoryEvent evt, ProcessMigrationPlan plan)
        {
