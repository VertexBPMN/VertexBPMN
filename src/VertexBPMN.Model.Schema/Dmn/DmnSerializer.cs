...
//using VertexBPMN.Domain.Model.Dmn12;
...
//        foreach (var imp in defs.Import)
...
//        foreach (var it in defs.ItemDefinition) root.Add(WriteItemDefinition(it));
//        foreach (var drg in defs.DrgElement) root.Add(WriteDRG(drg));
...
//        foreach (var c in i.ItemComponent) x.Add(WriteItemDefinition(c));
//        return x;
//    }
...
//        foreach (var ir in d.InformationRequirement)
//        {
//            var xir = new XElement("informationRequirement".N());
//            if (ir.RequiredDecision is not null) xir.Add(new XElement("requiredDecision".N(), new XAttribute("href", "#" + ir.RequiredDecision)));
//            if (ir.RequiredInput is not null) xir.Add(new XElement("requiredInput".N(), new XAttribute("href", "#" + ir.RequiredInput)));
//            x.Add(xir);
//        }
//        foreach (var kr in d.KnowledgeRequirement)
//        {
//            var xkr = new XElement("knowledgeRequirement".N());
//            if (kr.RequiredKnowledge is not null) xkr.Add(new XElement("requiredKnowledge".N(), new XAttribute("href", "#" + kr.RequiredKnowledge)));
//            x.Add(xkr);
//        }
//        foreach (var ar in d.AuthorityRequirement)
//        {
//            var xar = new XElement("authorityRequirement".N());
//            if (ar.RequiredAuthority is not null) xar.Add(new XElement("requiredAuthority".N(), new XAttribute("href", "#" + ar.RequiredAuthority)));
//            if (ar.RequiredDecision is not null) xar.Add(new XElement("requiredDecision".N(), new XAttribute("href", "#" + ar.RequiredDecision)));
//            if (ar.RequiredInput is not null) xar.Add(new XElement("requiredInput".N(), new XAttribute("href", "#" + ar.RequiredInput)));
//            x.Add(xar);
//        }
...
//        foreach (var od in ds.OutputDecision) x.Add(new XElement("outputDecision".N(), new XAttribute("href", "#" + od)));
//        foreach (var ed in ds.EncapsulatedDecision) x.Add(new XElement("encapsulatedDecision".N(), new XAttribute("href", "#" + ed)));
//        foreach (var id in ds.InputDecision) x.Add(new XElement("inputDecision".N(), new XAttribute("href", "#" + id)));
//        foreach (var ii in ds.InputData) x.Add(new XElement("inputData".N(), new XAttribute("href", "#" + ii)));
//        return x;
//    }
