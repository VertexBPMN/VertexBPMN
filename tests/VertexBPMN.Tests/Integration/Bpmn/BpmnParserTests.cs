...
{
    [Fact]
    public async Task Parses_CallActivity()
    {
    ...
    [Fact]
    public async Task Parses_AdHocSubProcess()
    {
    ...
    [Fact]
    public async Task Parses_EscalationEvent()
    {
    ...
    [Fact]
    public async Task Parses_TerminateEndEvent()
    {
    ...
    [Fact]
    public async Task Parses_ErrorEndEvent()
    {
    ...
    [Fact]
    public async Task Parses_Intermediate_Events()
    {
    ...
    [Fact]
    public async Task Parses_Event_Subprocess()
    {
    ...
    [Fact]
    public async Task Parses_Boundary_Event()
    {
    ...
    [Fact]
    public async Task Parses_Basic_Process()
    {
    ...
    [Fact]
    public async Task Parses_Events_And_SequenceFlows()
    {
    ...
    [Fact]
    public async Task Parses_Timer_Message_Signal_Conditional_Events()
    {
    ...
    [Fact]
    public async Task Parses_EventBasedGateway()
    {
    ...
    [Fact]
    public async Task Parses_ComplexGateway()
    {
    ...
    [Fact]
    public async Task Parses_TransactionalSubprocess_And_CompensationHandler()
    {
