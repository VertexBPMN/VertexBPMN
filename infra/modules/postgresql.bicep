@description('Azure region where the Flexible Server is deployed. This subscription has Flexible Server RESTRICTED in germanywestcentral/westeurope, so the caller must pass a supported region such as francecentral.')
...
param adminUsername string = 'vbpnadmin'
