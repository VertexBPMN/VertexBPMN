...
namespace VertexBPMN.Tests.Integration.Bpmn
{
    ...
    {
        [Fact]
        public async Task Executes_TimerEvent_FlowsToNext()
        {
            ...
            var trace = engine.ExecuteFromStartEvent(model, "start1");
        ...
        [Fact]
        public async Task Executes_MessageEvent_FlowsToNext()
        {
        ...
        [Fact]
        public async Task Executes_SignalEvent_FlowsToNext()
        {
        ...
        [Fact]
        public async Task Executes_ConditionalEvent_FlowsToNext()
        {
