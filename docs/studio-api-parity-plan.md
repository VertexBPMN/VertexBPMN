...
Service-Contract-Tests, API-Integrationstests fuer REST/gRPC, Blazor-UI-Tests fuer Kernworkflows und CLI-Dashboard-Tests werden ergaenzt.
...
| Debugging | Debug, Visual Debug, Visual Debugger | BPMN-Trace sowie Visual-Debug-Session, Breakpoint, Continue und Variableninspektion integriert; persistentes Step-over und Prozessvisualisierung bleiben deaktiviert, solange keine Engine-Operation dafür existiert | P2 |
