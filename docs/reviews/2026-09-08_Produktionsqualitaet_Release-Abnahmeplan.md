...
- [ ] Begrenzten Pilotbetrieb mit realen, vereinbarten Geschäftsabläufen und einer vorab festgelegten Beobachtungsdauer durchführen. **P8_AC_03** – benötigt Zielumgebung (Phase-0-Profil: Hosting/OS, IdP, Backup-/Alarmverantwortliche offen). **Offen.** Entscheidungsvorlage: [2026-09-09_Phase0_Zielumgebungsentscheidung.md](2026-09-09_Phase0_Zielumgebungsentscheidung.md).
