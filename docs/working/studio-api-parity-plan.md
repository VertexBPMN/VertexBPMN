...
| Analytics und ML | Analytics, ML Analytics, Metrics | Historische, tenant-isolierte Eventdaten werden als Trainingsdaten extrahiert; ML.NET-Dauer-/Completion-Prognosen, Bottleneck-/Optimierungsauswertung, Training und CSV-Export sind über API und Studio angebunden | P1 |
