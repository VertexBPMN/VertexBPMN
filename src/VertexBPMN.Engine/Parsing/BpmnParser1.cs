...
//using BpmnDataObject = VertexBPMN.Domain.Entities.Modeling.BpmnDataObject;
//using BpmnEvent = VertexBPMN.Domain.Entities.Modeling.BpmnEvent;
//using BpmnGateway = VertexBPMN.Domain.Entities.Modeling.BpmnGateway;
//using BpmnLane = VertexBPMN.Domain.Entities.Modeling.BpmnLane;
//using BpmnMessageFlow = VertexBPMN.Domain.Entities.Modeling.BpmnMessageFlow;
//using BpmnModel = VertexBPMN.Domain.Entities.Modeling.BpmnModel;
//using BpmnParticipant = VertexBPMN.Domain.Entities.Modeling.BpmnParticipant;
//using BpmnSequenceFlow = VertexBPMN.Domain.Entities.Modeling.BpmnSequenceFlow;
//using BpmnSubprocess = VertexBPMN.Domain.Entities.Modeling.BpmnSubprocess;
//using BpmnTask = VertexBPMN.Domain.Entities.Modeling.BpmnTask;
//using BpmnTextAnnotation = VertexBPMN.Domain.Entities.Modeling.BpmnTextAnnotation;
