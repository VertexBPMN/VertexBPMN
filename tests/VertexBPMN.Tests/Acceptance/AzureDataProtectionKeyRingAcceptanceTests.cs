...
public sealed class AzureDataProtectionKeyRingAcceptanceTests
{
    ...
    // Full blob URI, e.g. https://vbpnrgsa.blob.core.windows.net/dataprotection-api/keys.xml
    private static string BlobUri =>
        Environment.GetEnvironmentVariable("VERTEXBPMN_TEST_AZURE_DP_BLOB_URI") ?? "";

    // Full key identifier, e.g. https://vbpnrgkv.vault.azure.net/keys/dataprotection-key/<version>
