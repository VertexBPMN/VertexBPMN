...
using RepositoryService = VertexBPMN.Application.RepositoryService;
...
// Use ProductionProcessInstanceStore for persistence
builder.Services.AddScoped<IProcessInstanceStore, ProductionProcessInstanceStore>();
