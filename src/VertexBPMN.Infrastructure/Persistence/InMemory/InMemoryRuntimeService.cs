...
/// </summary>
public class InMemoryRuntimeService : IRuntimeService
{
    ...
    public InMemoryRuntimeService(IRepositoryService repositoryService, IProcessMiningEventSink eventSink)
    {
